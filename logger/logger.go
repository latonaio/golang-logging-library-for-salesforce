...
import (
	...
	salesforce_api_time_value_converter "github.com/latonaio/salesforce-api-time-value-converter"
)
...
func (l *Logger) log(msg interface{}, logLevel string, variableStr []interface{}) {
	...
	salesforce_api_time_value_converter.ChangeTimeFormatToReadableForStruct(&msg)
	// jsonに変換できる場合の処理
	if len(l.headerInfoMsg) > 0 {
